...
#圈x
[rewrite local]
https://m.jingxi.com/dreamfactory/generator/CollectCurrentElectricity? url script-request-header https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/jxcollect.js


#loon
http-request https://m.jingxi.com/dreamfactory/generator/CollectCurrentElectricity? script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/jxcollect.js, requires-body=true, timeout=10, tag=京喜工厂电力收取


#surge
京喜工厂电力收取 = type=http-request,pattern=https://m.jingxi.com/dreamfactory/generator/CollectCurrentElectricity?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/jxcollect.js,script-update-interval=0
*/

const Arisy = '京喜工厂收取电力'
const $ = Env(Arisy)
...
if($request&&$request.url.indexOf("CollectCurrentElectricity")>=0) {
   const jxcollecturl = $request.url.split('?')[1]
    ...
    $.log(`[${Arisy}] 获取jxcollecturl请求: 成功,jxcollecturl: ${jxcollecturl}`)
   ...
   const jxcollectheader = JSON.stringify($request.headers)
    ...
    $.log(`[${Arisy}] 获取jxcollectheader请求: 成功,jxcollectheader: ${jxcollectheader}`)
