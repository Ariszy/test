...
#圈x
[rewrite local]
luckycat/novel/v1/task/sign_in/* url script-request-header https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/fqxs.js


#loon
http-request luckycat/novel/v1/task/sign_in/* script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/fqxs.js, requires-body=true, timeout=10, tag=🍅番茄小说


#surge
🍅番茄小说 = type=http-request,pattern=luckycat/novel/v1/task/sign_in/*,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/fqxs.js,script-update-interval=0
