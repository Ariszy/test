...
#圈x
[rewrite local]
https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json url script-request-body https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/xp.js
#loon
http-request https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/xp.js, requires-body=true, timeout=10, tag=笑谱
#surge
笑谱 = type=http-request,pattern=^https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/xp.js,script-update-interval=0
*/
const jsname='笑谱'
const $ = Env(jsname)
