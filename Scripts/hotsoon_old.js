/*
github：https://github.com/Arisy/script
boxjs：https://raw.githubusercontent.com/Arisy/Private-Script/master/Arisy.boxjs.json
转载留个名字，谢谢
作者：执意Arisy
目前包含：
签到
...
#圈x
[rewrite local]
/luckycat/hotsoon/v1/task/done/daily_read_\d+m? url script-request-header https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js
/luckycat/hotsoon/v1/task/done/draw_excitation_ad? url script-request-header https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js
/luckycat/hotsoon/v1/task/sign_in_detail? script-request-header https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js
#loon
http-request /luckycat/hotsoon/v1/task/done/daily_read_\d+m? script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js, requires-body=true, timeout=10, tag=hotsoonread
http-request /luckycat/hotsoon/v1/task/done/draw_excitation_ad? script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js, requires-body=true, timeout=10, tag=hotsoonad
http-request /luckycat/hotsoon/v1/task/sign_in_detail? script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js, requires-body=true, timeout=10, tag=hotsoonsign
#surge
hotsoonsign = type=http-request,pattern=/luckycat/hotsoon/v1/task/sign_in_detail?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js,script-update-interval=0
hotsoonad = type=http-request,pattern=/luckycat/hotsoon/v1/task/done/draw_excitation_ad?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js,script-update-interval=0
hotsoonread = type=http-request,pattern=/luckycat/hotsoon/v1/task/done/daily_read_\d+m?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/Arisy/Private-Script/master/Scripts/hotsoon_old.js,script-update-interval=0
*/
